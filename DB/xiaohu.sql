...
Source Database       : xiaohu

Target Server Type    : MYSQL
Target Server Version : 50612
File Encoding         : 65001

Date: 2018-02-23 00:06:47
*/
...
CREATE TABLE `factory` (
  ...
  `update_at` varchar(11) NOT NULL DEFAULT '',
...
-- Records of factory
-- ----------------------------
INSERT INTO `factory` VALUES ('2', '一厂区', '1519313248', '1519313798', '1', '1');
...
-- Records of links
-- ----------------------------
INSERT INTO `links` VALUES ('1', '安全者', 'http://www.cnsecer.com', '100');
...
-- Records of member
-- ----------------------------
INSERT INTO `member` VALUES ('1', 'admin', '515343908@qq.com', '21232f297a57a5a743894a0e4a801fc3', null, '1436679338', '1519303431', '127.0.0.1', '1', '2');
...
-- Records of page
-- ----------------------------
INSERT INTO `page` VALUES ('1', '关于我们', 'about', '&lt;p&gt;&lt;br/&gt;&lt;/p&gt;&lt;p&gt;关于我们&lt;/p&gt;&lt;p&gt;关于我们&lt;/p&gt;&lt;p&gt;关于我们&lt;/p&gt;');
INSERT INTO `page` VALUES ('2', '联系我们', 'contact', '&lt;p&gt;&lt;br/&gt;&lt;/p&gt;&lt;p&gt;联系我们&lt;/p&gt;&lt;p&gt;联系我们&lt;/p&gt;&lt;p&gt;联系我们&lt;/p&gt;&lt;p&gt;联系我们&lt;/p&gt;&lt;p&gt;联系我们&lt;/p&gt;&lt;p&gt;联系我们&lt;/p&gt;&lt;p&gt;联系我们&lt;/p&gt;&lt;p&gt;联系我们&lt;/p&gt;&lt;p&gt;联系我们&lt;/p&gt;');
INSERT INTO `page` VALUES ('3', '', '第一厂区', null);
...
-- Records of setting
-- ----------------------------
INSERT INTO `setting` VALUES ('1', 'site-name', '安全者', '站点名');
INSERT INTO `setting` VALUES ('2', 'site-keywords', '关键词1,关键词2', '关键词');
INSERT INTO `setting` VALUES ('3', 'site-description', '站点描述信息', '站点描述');
INSERT INTO `setting` VALUES ('4', 'site-tongji', '&lt;script&gt; console.log(&quot;统计代码&quot;)&lt;/script&gt;', '统计代码');
INSERT INTO `setting` VALUES ('5', 'site-icp', '123456', 'ICP备案号');
INSERT INTO `setting` VALUES ('6', 'site-url', 'http://www.cnsecer.com', '站点地址');
...
CREATE TABLE `user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `subscribe` varchar(25) NOT NULL DEFAULT '',
  `openid` varchar(55) NOT NULL,
  `nickname` varchar(55) NOT NULL DEFAULT '',
  `sex` varchar(5) NOT NULL DEFAULT '1',
  ...
  `unionid` varchar(55) NOT NULL DEFAULT '',
  `remark` varchar(255) NOT NULL DEFAULT '',
  `groupid` int(11) NOT NULL DEFAULT '0',
  `tagid_list` varchar(255) DEFAULT '',
  `language` varchar(55) NOT NULL DEFAULT '',
  `country` varchar(55) NOT NULL DEFAULT '',
  `if_admin` int(2) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
